...
extension simd_float4x4 {
  ...
  static func rotationZ(angleRadians: Float) -> simd_float4x4 {
  ...
  static func rotationX(angleRadians: Float) -> simd_float4x4 {
    let c = cos(angleRadians)
    let s = sin(angleRadians)
    return simd_float4x4(
      SIMD4<Float>(1, 0,  0, 0),
  ...
  static func rotationY(angleRadians: Float) -> simd_float4x4 {
    let c = cos(angleRadians)
    let s = sin(angleRadians)
    return simd_float4x4(
      SIMD4<Float>( c, 0, -s, 0),
